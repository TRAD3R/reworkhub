...
<head>
  ...
  <noscript><div><img src="https://mc.yandex.ru/watch/63634387" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
  <!-- /Yandex.Metrika counter -->
  <script>
      window.replainSettings = { id: '5cc1131b-5909-41f7-86a5-41326983187d' };
...
<div id="wrapper">
    ...
    <footer id="footer">
        <div class="footer-holder">
            <div class="box-email">
                <a href="mailto:info@udalyonka.com" class="email">
            ...
            <div class="box-copyright">&copy; Copyright 2020</div>
...
<!--                    </svg>-->
<!--                </a>-->
                <a class="social-links-item social-links-item-min sl-telegram"
                   href="https://t.me/joinchat/AAAAAFQzh6UEUQVWgHSMFw"
                   target="_blank">
                    <span class="icon">
                      <svg width="21" height="17" viewBox="0 0 21 17" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.6646 0.110375L0.934606 6.94737C-0.275394 7.43337 -0.268393 8.10837 0.712607 8.40937L5.26461 9.82937L15.7966 3.18437C16.2946 2.88137 16.7496 3.04437 16.3756 3.37637L7.84261 11.0774H7.84061L7.84261 11.0784L7.52861 15.7704C7.98861 15.7704 8.19161 15.5594 8.44961 15.3104L10.6606 13.1604L15.2596 16.5574C16.1076 17.0244 16.7166 16.7844 16.9276 15.7724L19.9466 1.54437C20.2556 0.305375 19.4736 -0.255625 18.6646 0.110375V0.110375Z" fill="inherit"/>
